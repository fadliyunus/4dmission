 ...
 */
$config['site_title']                 = "PPM School of Management";       // Site Title, example.com
$config['admin_email']                = "admission@ppmschool.ac.id"; // Admin Email, admin@example.com
...
$config['email_config'] = [
	'mailtype' => 'html',
    'protocol'    => 'smtp',
    'smtp_host'    => 'mail.ppmschool.ac.id',
    'smtp_port'    => '465',
    'smtp_timeout' => '300',
    'smtp_user'    => 'admission@ppmschool.ac.id',
    'smtp_pass'    => '9Cz5ogPhu{oh',
		'smtp_crypto' => 'ssl',
    'charset'    => 'utf-8',
    'newline'    => "\r\n",
    'validation' => TRUE	
...
/*
 ...
 | Default: auth/
 */
$config['email_templates'] = 'home/email/';
