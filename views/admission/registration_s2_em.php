<section id="content">
    <div class="content-wrap">
        <div class="container">
            ...
            <?php endif; ?>
            <?= form_open_multipart('', ['id' => 'registration_form','autocomplete'=>'off']) ?>
            ...
            <div class="form-group row">
                <label class="col-sm-3 col-form-label">Nama Sekolah/Universitas/College</label>
                <div class="col-sm-9">
