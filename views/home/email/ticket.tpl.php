<div style="font-family:'HelveticaNeue-Light','Helvetica Neue Light','Segoe UI Light','Helvetica Neue','Segoe UI',Helvetica,Arial,sans-serif;">
    ...
    <?php if ($admission->tes_seleksi) : ?>
        <?php if ($admission->status == 301) : ?>
            ...
            <p>Terima kasih telah menyelesaikan pendaftaran di PPM School of Management.</p>
            <p>Berdasarkan pendaftaran Anda di PPM School of Management sebagai calon mahasiswa program sarjana tahun <?= $angkatan->tahun_ajaran ?> dengan ini kami mengundang <?= $admission->full_name; ?> untuk mengikuti tes seleksi via daring (online).</p>
